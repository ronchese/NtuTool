...
static NANOTypeReader<std::string> tr____x( new DataResetString( DataReset::stl_read ), new NANOHandler::ConvertToString );
...
static NANOTypeReader< std::vector<int      > > tr_v__i( new DataResetVector<int>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,int> );
...
static NANOTypeReader< std::vector<unsigned
                                   int      > > tr_v_ui( new DataResetVector<unsigned int>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,unsigned int> );
...
static NANOTypeReader< std::vector<short    > > tr_v__s( new DataResetVector<short>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,short> );
...
static NANOTypeReader< std::vector<unsigned
                                   short    > > tr_v_us( new DataResetVector<unsigned short>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,unsigned short> );
...
static NANOTypeReader< std::vector<char     > > tr_v__b( new DataResetVector<char>( DataReset::stl_read ), new NANOHandler::ConvertToVector<unsigned char,char> );
...
static NANOTypeReader< std::vector<unsigned
                                   char     > > tr_v_ub( new DataResetVector<unsigned char>( DataReset::stl_read ), new NANOHandler::ConvertToVector<unsigned char,unsigned char> );
...
static NANOTypeReader< std::vector<bool     > > tr_v__a( new DataResetVector<bool>( DataReset::stl_read ), new NANOHandler::ConvertToVector<bool,bool> );
...
static NANOTypeReader< std::vector<long long> > tr_v__l( new DataResetVector<long long>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,long long> );
...
static NANOTypeReader< std::vector<unsigned
                                   long long> > tr_v_ul( new DataResetVector<unsigned long long>( DataReset::stl_read ), new NANOHandler::ConvertToVector<int,unsigned long long> );
...
static NANOTypeReader< std::vector<float    > > tr_v__f( new DataResetVector<float>( DataReset::stl_read ), new NANOHandler::ConvertToVector<float,float> );
...
static NANOTypeReader< std::vector<double   > > tr_v__d( new DataResetVector<double>( DataReset::stl_read ), new NANOHandler::ConvertToVector<float,double> );
...
static NANOTypeReader< std::vector<std::string> > tr_v__x( new DataResetVector<std::string>( DataReset::stl_read ), nullptr );

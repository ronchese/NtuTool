...
void   NANOTypeWriter<int      >::addC( const void* p, void* t,
  ...
  this->addC<int>( p, t, name, doc, nanoaod::FlatTable::IntColumn );
  return;
}
...
void   NANOTypeWriter<char     >::addC( const void* p, void* t,
                                        const std::string& name,
                                        const std::string& doc ) {
  this->addC<unsigned char>( p, t, name, doc, nanoaod::FlatTable::UInt8Column );
  return;
}
...
void   NANOTypeWriter<bool     >::addC( const void* p, void* t,
                                        const std::string& name,
                                        const std::string& doc ) {
  this->addC<bool>( p, t, name, doc, nanoaod::FlatTable::BoolColumn );
  return;
}
static NANOTypeWriter<unsigned
...
void   NANOTypeWriter<float    >::addC( const void* p, void* t,
                                        const std::string& name,
                                        const std::string& doc ) {
  this->addC<float>( p, t, name, doc, nanoaod::FlatTable::FloatColumn );
  return;
}

...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('simple_tree.root'),
    closeFileFast = cms.untracked.bool(True)
)

process.simpleLegacyModule = cms.EDAnalyzer( 'SimpleLegacyModule',
### if the file name is given as "-" use the TFileService file
    fileName = cms.untracked.string('-')
#    fileName = cms.untracked.string('another_tree.root')
   ,
...
process.p = cms.Path(process.simpleLegacyModule)
